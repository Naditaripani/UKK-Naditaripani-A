                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    <div class="text-center">
                                        <img src="{{ asset('assets/landing/img/logowk.png') }}" style="width:80px" alt="logo">
                                        <h1 class="h4 text-gray-900 mb-4">From Register</h1>
                                    </div>
                                    <form class="user" action="{{ route('laporma.register') }}" method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <input type="number" class="form-control form-control-user" placeholder="NIK" name="nik">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="number" class="form-control form-control-user" placeholder="Nomor Telp" name="telp">
                                        </div>
