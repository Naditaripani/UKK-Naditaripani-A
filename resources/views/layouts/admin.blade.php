    ...
    <div class="wrapper">
        <nav id="sidebar">
            <div class="sidebar-header">
                <center>
                <img src="{{ asset('assets/landing/img/logowk.png') }}" alt="Logo Wikrama" style="width: 80px;">
                <h3 class="mb-0">Laporma!</h3>
                <p class="text-white mb-0">Laporan Pengaduan Wikrama</p>
            </center>
            </div>
            ...
            <ul class="list-unstyled components">
                ...
                <br>
                <li class="">
                    <a href="{{ route('admin.logout') }}" onclick="return confirm('Apakah anda yakin ingin keluar ?')">Logout</a>
                </li>
