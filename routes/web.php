...
Route::middleware(['isMasyarakat'])->group(function () {
    ...
    // Route::get('/public/{id_tanggapan}', [UserController::class, 'public'])->name('laporan.public');
    // Route::get('/private/{id_tanggapan}', [UserController::class, 'private'])->name('laporan.private');
});
